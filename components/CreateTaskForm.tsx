...
const CreateTaskForm: React.FC<Props> = ({onSuccess}) => {
    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="title" placeholder="Add a task title" autoComplete="off" className="text-input new-task-text-input" value={title} onChange={handleTitleChange}/>
        </form>
    )
}
